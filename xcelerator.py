...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Підготовка датасету для прогнозування відтоку клієнтів (Churn Prediction)")
    ...
    parser.add_argument("--horizon", type=int, default=90, help="Горизонт прогнозування відтоку в днях (за замовчуванням 90)")
    ...
    print("Генерація базових фіч (Feature Engineering)...")
    ...
    featured_path = out_dir / "featured_data.csv" # <--- Додаємо шлях
